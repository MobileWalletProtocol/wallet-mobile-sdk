# -*- encoding: utf-8 -*-
# stub: google-cloud-storage 1.39.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<google-apis-storage_v1>.freeze, ["~> 0.17.0"])
    ...
    s.add_dependency(%q<google-apis-storage_v1>.freeze, ["~> 0.17.0"])
